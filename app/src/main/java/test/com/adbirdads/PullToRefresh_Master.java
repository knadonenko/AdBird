...
public class PullToRefresh_Master extends ListView implements OnScrollListener 
{
    ...
    public PullToRefresh_Master(Context context) 
    {
        super(context);
        init(context);
    }

    public PullToRefresh_Master(Context context, AttributeSet attrs) 
    {
        super(context, attrs);
        init(context);
    }

    public PullToRefresh_Master(Context context, AttributeSet attrs, int defStyle) 
    {
    ...
    private void init(Context context) 
    {
		...
		mRefreshView = (RelativeLayout) mInflater.inflate(R.layout.listview_pull_to_refresh_header, this, false);
    ...
    private void resetHeader() 
    {
        if (mRefreshState != TAP_TO_REFRESH) 
        {
            ...
            mRefreshViewImage.setImageResource(R.drawable.pulltorefresh_arrow);
